...
bool GifWriteFrame( GifWriter* writer, unsigned char const* image, unsigned int width, unsigned int height, unsigned int delay, int bitDepth = 8, bool dither = false );
